    ...
    <Sidebar className="border-r bg-white" collapsible="icon">
      ...
      <SidebarContent>
        <SidebarMenu>
          ...
          {/* Advertisement Menu */}
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={isActive("/advertisement")} tooltip={t("advertisement")}>
          ...
          {/* News Menu */}
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={isActive("/news")} tooltip={t("news")}>
              <Link href="/news">
          ...
          {/* Tribute Menu */}
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={isActive("/tribute")} tooltip={t("tribute")}>
              <Link href="/tribute">

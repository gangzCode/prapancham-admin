    ...
    useEffect(() => {
        async function fetchNews() {
            try {
                ...
                // Mock data for the example - using the first news article from our sample data
                const newsData = {
                    id: params.id,
                    title: {
                        en: [{ name: "title", value: "Local Community Celebrates Annual Festival" }],
                        ta: [{ name: "title", value: "உள்ளூர் சமூகம் வருடாந்திர விழாவைக் கொண்டாடுகிறது" }],
                        si: [{ name: "title", value: "ප්‍රාදේශීය ප්‍රජාව වාර්ෂික උත්සවය සමරයි" }],
                    },
                    description: {
                        en: [
                            {
                                name: "description",
                                value:
                                    "The local community came together to celebrate their annual cultural festival with music, food, and traditional performances.",
                            },
                        ],
                        ta: [
                            {
                                name: "description",
                                value: "உள்ளூர் சமூகம் இசை, உணவு மற்றும் பாரம்பரிய நிகழ்ச்சிகளுடன் தங்கள் வருடாந்திர கலாச்சார விழாவைக் கொண்டாட ஒன்றிணைந்தது.",
                            },
                        ],
                        si: [
                            {
                                name: "description",
                                value: "ප්‍රාදේශීය ප්‍රජාව සංගීතය, ආහාර සහ සාම්ප්‍රදායික ඉදිරිපත් කිරීම් සමඟ ඔවුන්ගේ වාර්ෂික සංස්කෘතික උත්සවය සැමරීමට එක්රැස් විය.",
                            },
                        ],
                    },
                    thumbnailImage: "/placeholder.svg?height=100&width=150",
                    mainImage: "/placeholder.svg?height=400&width=600",
                    otherImages: ["/placeholder.svg?height=200&width=300", "/placeholder.svg?height=200&width=300"],
                    paragraphs: [
                        {
                            en: [
                                {
                                    name: "paragraph",
                                    value:
                                        "The festival featured performances from local artists and musicians, showcasing the rich cultural heritage of the community.",
                                },
                            ],
                            ta: [
                                {
                                    name: "paragraph",
                                    value:
                                        "விழாவில் உள்ளூர் கலைஞர்கள் மற்றும் இசைக்கலைஞர்களின் நிகழ்ச்சிகள் இடம்பெற்றன, சமூகத்தின் செழுமையான கலாச்சார பாரம்பரியத்தை வெளிப்படுத்தின.",
                                },
                            ],
                            si: [
                                {
                                    name: "paragraph",
                                    value: "උත්සවයේ දේශීය කලාකරුවන් සහ සංගීතඥයින්ගේ ඉදිරිපත් කිරීම් ඇතුළත් වූ අතර, ප්‍රජාවේ පොහොසත් සංස්කෘතික උරුමය පෙන්නුම් කෙරිණි.",
                                },
                            ],
                        },
                    ],
                    editorName: {
                        en: [{ name: "editor", value: "John Smith" }],
                        ta: [{ name: "editor", value: "ஜான் ஸ்மித்" }],
                        si: [{ name: "editor", value: "ජොන් ස්මිත්" }],
                    },
                    newsCategory: "1",
                    isBreakingNews: false,
                ...
                form.reset({
                    ...
                    otherImages: newsData.otherImages,
                    paragraphs: newsData.paragraphs,
                    editorName: newsData.editorName,
                    newsCategory: newsData.newsCategory,
                    isBreakingNews: newsData.isBreakingNews,
                    isImportantNews: newsData.isImportantNews,
                    isDeleted: newsData.isDeleted,
                })

                setOtherImages(newsData.otherImages)
            } catch (error) {
                toast({
                    title: "Error",

...
export default function CountryPage() {
  ...
  const handleAddCountry = () => router.push("/country/new")
        ...
        {viewCountry && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-sm text-muted-foreground">Currency Code</h3>
              <p className="font-medium">{viewCountry.currencyCode}</p>
            </div>
